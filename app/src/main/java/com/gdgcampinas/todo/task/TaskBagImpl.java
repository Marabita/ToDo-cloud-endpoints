...
import com.gdgcampinas.backend.taskApi.TaskApi;
import com.gdgcampinas.backend.taskApi.model.TaskBean;
...
public class TaskBagImpl implements TaskBag {
    ...
    public TaskBagImpl() {
        ...
        TaskApi.Builder builder = new TaskApi.Builder(AndroidHttp.newCompatibleTransport(),
                ...
                .setRootUrl("https://task-gdg-campinas.appspot.com/_ah/api/")
